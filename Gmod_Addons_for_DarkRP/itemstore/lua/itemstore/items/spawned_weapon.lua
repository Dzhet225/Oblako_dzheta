...
function ITEM:SaveData( ent )
	...
	self:SetData( "Clip1", ent.clip1 and ent.clip1 * ent:Getamount() or 0 )
	self:SetData( "Clip2", ent.clip2 and ent.clip2 * ent:Getamount() or 0 )
	self:SetData( "Ammo", ent.ammoadd and ent.ammoadd * ent:Getamount() or 0 )
end

function ITEM:CanPickup( pl, ent )
	return self.MaxStack >= ent:Getamount()
end
